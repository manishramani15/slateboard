...
<body>
	...
	<div class="container">
		...
		<form:form class="form-horizontal" modelAttribute="courseMaterial" action="posted-coursematerial.htm?courseId=${requestScope.courseId }" method="post" enctype="multipart/form-data">

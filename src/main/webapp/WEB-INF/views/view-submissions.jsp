...
<head>
<meta charset="UTF-8">
<title>Slateboard - View Assignment Submissions</title>
<link rel="stylesheet"
		...
		<div class="list-group">
			...
			<div class="card">
				<div class="card-body">
					...
					Your Submission: <a href="/imagefolder/<%=studentAssignment.getFilePath()%>"
						class="list-group-item">Submission File: <%=studentAssignment.getFilePath()%></a>
					<span class="row"><span class="col-sm-5">Grade: <%

...
<body>
	...
	<div class="container">
		...
		<div class="alert alert-danger">
			<strong>Error!</strong> You cannot submit the assignment now as the deadline has passed.
		</div>
		<%
			} else {
		%>
		<div class="alert alert-warning">
			...
			You can not resubmit the assignment!
		</div>
		<%
			}
				}
		...
		<form:form class="form-horizontal" modelAttribute="studentAssignment"
			action="submitted-assignment.htm" method="post"
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="assignment">Select
					Assignment:</label>
				<div class="col-sm-10">
					<select name="assignmentId" class="form-control" id="assignment">
						<%
							List<Assignment> assignments = (List<Assignment>) request.getAttribute("assignments");
								if (assignments != null) {
									for (Assignment assignment : assignments) {
						%>
						<option value="<%=assignment.getId()%>"><%=assignment.getNotes()%></option>
						<%
							}
								}
						%>

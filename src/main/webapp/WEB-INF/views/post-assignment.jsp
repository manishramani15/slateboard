...
<body>
	...
	<div class="container">
		...
		<form:form class="form-horizontal" modelAttribute="assignment" action="posted-assignment.htm?courseId=${requestScope.courseId }" method="post" enctype="multipart/form-data">

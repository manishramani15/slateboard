...
<%@ page import="com.mycompany.slateboard.pojo.CourseMaterial"%>
<%@ page import="javax.servlet.http.HttpSession"%>
...
<body>
	...
	<div class="container">
		<div class="list-group">
			<%
				ArrayList<CourseMaterial> courseMaterials = (ArrayList<CourseMaterial>) request.getAttribute("courseMaterials");
				for (CourseMaterial courseMaterial : courseMaterials) {
			%>

			<a href="/imagefolder/<%=courseMaterial.getFilePath()%>" class="list-group-item"><%=courseMaterial.getNotes()%></a>

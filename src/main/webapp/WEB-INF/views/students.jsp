...
<body>
	...
	<div class="container">
		<div class="list-group">
			...
			%>
			<div class="row">
			<a href="student.htm?id=<%=studentCourse.getStudent().getId()%>" class="list-group-item col-sm-9"><%=studentCourse.getStudent().getName()%></a>
			<a href="submissions.htm?id=<%=studentCourse.getStudent().getId()%>" class="btn btn-info col-sm-2" role="button">Submissions</a>
			</div>
			<%
				}
			%>
